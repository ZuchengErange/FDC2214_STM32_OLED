...
//IO方向设置
#define FDC_SDA_IN()   {GPIOA->CRL=0X3883FFFF;}            //{GPIOA->CRL&=0XFF0FFFFF;GPIOA->CRL|=8<<4*5;}配置其io口
#define FDC_SDA_OUT()  {GPIOA->CRL=0X3333FFFF;}            //{GPIOA->CRL&=0XFF0FFFFF;GPIOA->CRL|=3<<4*5;}

//IO操作函数	 
#define FDC_IIC_SCL    PAout(4) 	//SCL
#define FDC_IIC_SDA    PAout(5)   //输出SDA	 
#define FDC_READ_SDA   PAin(5) 		//输入SDA 

#define FDC_IIC_SCL1    PAout(7) 	//SCL
#define FDC_IIC_SDA1    PAout(6)   //输出SDA	 
#define FDC_READ_SDA1   PAin(6) 		//输入SDA 
